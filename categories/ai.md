...
| [samantha](https://github.com/lancekrogers/samantha)                     | Go         | 2026-03-16 | Low-latency (<2s) voice assistant for AI coding, written in Go — a concurrent goroutine pipeline (VAD → local STT...     |
...
_23 projects in this category. [Back to catalog](../README.md)._
